...
Trace는 등록된 변환 이름과 단계 상태를 표로 표시합니다. Output 내부 너비가 70열
이상이면 Input, Output, Time을 각각 표시하고, 그보다 좁으면 Input과 Output을 Size로
합치고 Time을 생략합니다. 첫 실패의 안전한 오류 요약은 표 아래에 자동 표시하며,
